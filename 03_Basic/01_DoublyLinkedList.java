...
public class DoublyLinkedList {
	    ...
	    public static void main(String[] args) {
	    	DoublyLinkedList aa = new DoublyLinkedList();
...
//						System.out.println("Node " + current.data + " is at location " + i );
					    System.out.println("Node " + current.data + " is at location " + i + " : Previous Node: null : Next Node: "+current.next.data);
					else if(current.next == null)
						System.out.println("Node " + current.data + " is at location " + i + " : Previous Node: "+current.prev.data + " : Next Node: null");
					else System.out.println("Node " + current.data + " is at location " + i + " : Previous Node: "+current.prev.data + " : Next Node: "+current.next.data);
					current = current.next;
				}
				System.out.println("Head: "+ this.head.data + " and Tail:"+ this.tail.data);
			}
		}
